...
- Supports multiple executors: Volt, Synapse Z, Potassium, Wave
- Universal loader (xcutorsLoader) for easy script injection
- User-friendly interface designed for Windows desktop
- Regular updates to maintain compatibility
- Lua script execution support for Roblox games
- Customization options for script management
- Secure and stable performance during use
- Detailed documentation and guides provided
- Compatibility with a wide range of Roblox titles
...
XCutors is a collection of Roblox executors and a universal loader for running Lua scripts on Windows.

### Which executors are included?

The package includes Volt, Synapse Z, Potassium, Wave, and the xcutorsLoader universal loader.

### Is it safe to use?

The tools are intended for legitimate script customization. Use responsibly and adhere to Roblox terms of service.

### How do I install XCutors?

Download the repository, extract it, and run the loader as administrator. Follow the installation steps in the README.

### What are the system requirements?

XCutors requires Windows 10 or later, with adequate RAM and storage space for smooth operation.

### Can it run on Mac or Linux?

No, XCutors is designed exclusively for Windows desktop systems.

### How do I update to the latest version?

Check the GitHub releases page, download the new version, and replace the old files with the updated ones.
